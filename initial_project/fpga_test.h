...
typedef struct {
  real_T my_input;                     /* '<Root>/my_input' */
} ExtU_fpga_test_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T my_output;                    /* '<Root>/my_output' */
} ExtY_fpga_test_T;
...
extern void fpga_test_initialize(void);
extern void fpga_test_step(void);
...
extern RT_MODEL_fpga_test_T *const fpga_test_M;
