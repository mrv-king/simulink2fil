...
#
# Script generated by Vivado on Thu Aug 31 17:43:46 +0200 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fpga_test_initialize_0 xil_defaultlib.fpga_test_initialize_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpga_test_initialize_0 -key {Behavioral:sim_1:Functional:fpga_test_initialize_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpga_test_initialize_0.wdb xsim.dir libdpi.so)
