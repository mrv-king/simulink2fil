...
#
# Script generated by Vivado on Tue Aug 29 18:47:02 +0200 2023
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fpga_test_step_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fpga_test_step_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fpga_test_step_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
