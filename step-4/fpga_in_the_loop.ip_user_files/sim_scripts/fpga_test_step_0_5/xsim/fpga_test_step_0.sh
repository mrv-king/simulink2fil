...
#
# Script generated by Vivado on Fri Aug 25 16:20:13 +0200 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fpga_test_step_0 xil_defaultlib.fpga_test_step_0 xil_defaultlib.glbl -log elaborate.log
}
