...
#
# Script generated by Vivado on Wed Aug 23 22:49:18 +0200 2023
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpga_model_0.wdb xsim.dir libdpi.so)
