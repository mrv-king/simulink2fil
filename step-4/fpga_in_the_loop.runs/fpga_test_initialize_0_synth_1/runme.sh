...
HD_PWD='C:/Users/nikgal/Vivado/fpga_in_the_loop/fpga_in_the_loop.runs/fpga_test_initialize_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_test_initialize_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_test_initialize_0.tcl
