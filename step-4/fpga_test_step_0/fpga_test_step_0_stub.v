...
// Command     : write_verilog -force -mode synth_stub -rename_top fpga_test_step_0 -prefix
//               fpga_test_step_0_ fpga_test_step_0_stub.v
...
(* X_CORE_INFO = "fpga_test_step,Vivado 2023.1" *)
module fpga_test_step_0(fpga_test_Y_ap_vld, 
  fpga_test_B_StateSpace_o1_ce0, p_fpga_test_B_AC_ap_vld, 
  ...
  fpga_test_DW_StateSpace_IWORK_ce0, fpga_test_DW_StateSpace_IWORK_ce1, 
  ...
  p_fpga_test_DW_u5_Mode_ap_vld, fpga_test_M_o_ap_vld, ap_clk, ap_rst, ap_start, ap_done, 
  ap_idle, ap_ready, fpga_test_U, fpga_test_Y, fpga_test_B_AC, 
  fpga_test_B_StateSpace_o1_address0, fpga_test_B_StateSpace_o1_q0, 
  fpga_test_B_StateSpace_o2, fpga_test_B_DataTypeConversion2, fpga_test_B_LookUpTable, 
  fpga_test_B_IC, fpga_test_B_Derivative, fpga_test_B_DataTypeConversion1, 
  p_fpga_test_B_AC, p_fpga_test_B_StateSpace_o1_address0, 
  ...
  fpga_test_DW_DelayTs_DSTATE, fpga_test_DW_DelayTs_DSTATE_f, 
  fpga_test_DW_IC_FirstOutputTime, fpga_test_DW_TimeStampA, fpga_test_DW_LastUAtTimeA, 
  fpga_test_DW_TimeStampB, fpga_test_DW_LastUAtTimeB, fpga_test_DW_StateSpace_PWORK, 
  fpga_test_DW_StateSpace_IWORK_address0, fpga_test_DW_StateSpace_IWORK_q0, 
  fpga_test_DW_StateSpace_IWORK_address1, fpga_test_DW_StateSpace_IWORK_q1, 
  fpga_test_DW_u5_Mode, p_fpga_test_DW_DelayTs_DSTATE, p_fpga_test_DW_DelayTs_DSTATE_f, 
